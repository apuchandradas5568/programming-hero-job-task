...
const LoginPage = () => {
  ...
  return (
    <div className="login-container max-w-md mx-auto p-4 mt-10 ">
      ...
      <hr className="border h-1 border-t-0 border-l-0 border-r-0 border-blue-500 border-dashed mt-8" />
      ...
      <div className="social-login mt-8 text-center">
        ...
        <div className="flex justify-center gap-4 mt-4">
          <button
            ...
            className="border-blue-600 hover:bg-blue-600 hover:text-white text-blue-600 border rounded-md py-2 px-4"
          >
            Google
          </button>
        </div>
